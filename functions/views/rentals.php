...
?>
    <tr>
        ...
        <td class="text-center">
            <a class="btn btn-primary mx-1" role="button" href="profile.php" data-bs-target="#pay" data-bs-toggle="modal" data-id="<?= $row['id'] ?>" data-room="<?= $row['room'] ?>" data-total="<?= $total ?>" style="border-color: #1CC88A;background-color:#1CC88A">
