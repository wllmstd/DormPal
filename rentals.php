            ...
            <div id="content">
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0" style="font-weight: 700">Rentals</h3>
                    </div>
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <p class="m-0 fw-bold" style="color:#ff9220;">Rentals Lists</p>
                        </div>
                        <div class="card-body">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" style="font-weight: 700;color:#ff9220;">Payment</h4>
                    <button class="btn-close" type="button" aria-label="Close" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body">
                    <form action="functions/payment.php" method="post" id="paymentForm">
                        <input type="hidden" name="id">
                        <input type="hidden" name="room">
                        <input type="hidden" name="total">
                        <div class="form-floating mb-3">
                            <input id="amountInput" class="form-control form-control" type="number" placeholder="Amount"
                                min="1" name="amount">
                ...
                <div class="modal-footer">
                    <button id="saveButton" class="btn btn-primary" type="submit" form="paymentForm"
                    ...
                    <script>
                        $(document).ready(function () {
                            $('#saveButton').click(function () {
                                ...
                                $.ajax({
                                    url: 'send.php', // Path to your PHP file
                                    type: 'POST',
                                    data: { amount: amount },
                                });
                            });
